    ...
    <div class="panel-body">
        ...
        <table id="data-table" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <th>Menu Items</th>
                <th>Orders</th>                                         <th>Show Homepage</th>                         
            ...
            <tr>
                ...
                <td>{{App\Restaurants::getOrders($restaurant->id)}}</td>                                      <td>{{$restaurant->show_home}}</td>                          
                <td class="text-center">
				
                <a href="{{ url('admin/restaurants/images/'.$restaurant->id) }}" class="btn btn-default btn-rounded"><i class="fa fa-picture-o" aria-hidden="true"></i></a>
