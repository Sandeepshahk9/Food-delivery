    ...
    <div class="panel-body">
        ...
        <table id="order_data_table" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <th>Address</th>
                <th>Restaurants </th>
                <th>Menu Name</th>				<th>Order Description</th>
                <th>Quantity</th>
                <th>Item Price</th>
            ...
            <tr>
                <td>{{ date('m-d-Y h:i a',strtotime($order->created_date))}}</td>
                ...
                <td><a href="{{ url('admin/restaurants/view/'.$order->restaurant_id) }}" class="text-regular">{{ $res->restaurant_name }}</a>
                </td>
