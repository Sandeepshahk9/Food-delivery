...
<div id="main">
	<div class="page-header">
		<div class="pull-right" style="width:300px;">	
			{!! Form::open(array('url' => 'admin/import_excel','class'=>'', 'name'=>'import_form','id'=>'import_form','role'=>'form', 'enctype' => 'multipart/form-data')) !!}											
			<input type="file" name="file"/>			
			<input type="hidden" name="res_id" value="{{$restaurant_id}}"/>			
			<button type="submit" name="submit" class="btn btn-success">Import/CSV</button>
			{!! Form::close() !!} 			
