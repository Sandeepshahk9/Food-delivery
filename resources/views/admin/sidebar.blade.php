	...
	<div class="nicescroll">
		<div class="wrapper" style="margin-bottom:90px">
			<ul class="nav nav-sidebar" id="sidebar-menu">
	                ...
	                <li class="{{classActivePath('settings')}}"><a href="{{ URL::to('admin/settings') }}"><i class="md md-settings"></i>Settings</a></li>					<li class="{{classActivePath('settings')}}"><a href="{{ URL::to('admin/location') }}"><i class="md md-settings"></i>Location</a></li>
