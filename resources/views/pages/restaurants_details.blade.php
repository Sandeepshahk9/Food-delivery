...
<div class="restaurant_list_detail">
    <div class="container">
      ...
      <div class="box_style_2">
              <h2 class="inner">Restaurant Name</h2>
			  <div class="m-desp-img-res">
				  <ul class="nav nav-tabs">
					  <li class="active"><a data-toggle="tab" href="#home">Description</a></li>
					  <li><a data-toggle="tab" href="#img-gal">Image Gallery</a></li>				 
					</ul>
            ...
            @endif
					  ...
					  <div id="img-gal" class="tab-pane fade">
						<div class="row">
							<?
							$images = DB::table('restaurant_images')->where('restaurant_id',$restaurant->id)->get();
							if($images) {
							foreach($images as $img){
							?>
							<div class="col-lg-3 col-md-3 col-xs-4 col-xs-6">
								<div class="rest-desp-img-t">						 
									<img src="{{ URL::asset('upload/restaurants/additional/'.$img->images) }}" alt="Mountains" >						  					 
								</div>
							</div>
							<? } } ?>
